   ...
   //HTML build for welcome Email.
    private String buildWelcomeEmailHtml(String studentName) {
    	return "<html>" +
    		       ...
    		       "      Developed by <a href=\"mailto:bhiseamarwagholi@gmail.com\" style=\"color:#2E86C1; text-decoration:none;\">bhiseamarwagholi@gmail.com</a>" +
    		       "    </p>" +
    		       "  </div>" +
    		       "</body>" +
    		       "</html>";
    ...
    private String buildQuizCompletionEmailHtml(String studentName, int finalScore) {
    	return "<html>" +
    		       ...
    		       "    <hr style=\"border:none; border-top:1px solid #eee; margin: 30px 0;\"/>" +
    		       "    <p style=\"font-size: 0.85em; color: #666; text-align: center;\">" +
    		       "      Developed by <a href=\"mailto:bhiseamarwagholi@gmail.com\" style=\"color:#27AE60; text-decoration:none;\">bhiseamarwagholi@gmail.com</a>" +
    		       "    </p>" +
    		       "  </div>" +
    		       "</body>" +
    		       "</html>";
...
//                "<p style='font-size:0.9em; color:#666;'>Developed by <a href='mailto:bhiseamarwagholi@gmail.com'>bhiseamarwagholi@gmail.com</a></p>" +
//                "</body>" +
//                "</html>";
//    }
//
